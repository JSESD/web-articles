...
\chead{%
  ...
  \or \includegraphics[width=\textwidth]{JSESD_JournalBanner_Perspectives-1.png}% page=1
  \or \includegraphics[width=\textwidth]{JSESD_JournalBanner_Perspectives-1.png}% page = 2
  \or \includegraphics[width=\textwidth]{JSESD_JournalBanner_Perspectives-1.png}% page = 3
  \or \includegraphics[width=\textwidth]{JSESD_JournalBanner_Perspectives-1.png}% page = 4
  \or \includegraphics[width=\textwidth]{JSESD_JournalBanner_Perspectives-1.png}% page = 5
  \else
  \includegraphics[width=\textwidth]{JSESD_JournalBanner_Perspectives-1.png}
  \fi
}
