...
\chead{%
  ...
  \or \includegraphics[width=\textwidth]{headerImage}% page = 1
  \or \includegraphics[width=\textwidth]{headerImage}% page = 2
  \or \includegraphics[width=\textwidth]{headerImage}% page = 3
  \or \includegraphics[width=\textwidth]{headerImage}
  % page = 4
  \or \includegraphics[width=\textwidth]{headerImage}% page = 5
  \else
...
\fancyfoot[LE,LO]{Interaction between students with and without disabilities in an inclusive schools from their teachers perspective.
DOI:10.14448/jsesd.14.0009 }
\fancyfoot[CE,CO]{{ }}
...
T1 & Bachelor & 12 years \\
T2 & Bachelor & 10 years \\
T3 & Masters & 15 years \\
T4 & Bachelor & 10 years \\
T5 & Bachelor & 17 years \\
T6 & Bachelor & 10 years \\
T7 & Bachelor & 14 years \\
T8 & Bachelor & 15 years \\
...
\begin{tabular}{ll}
\hline
\multicolumn{1}{c}{\textbf{Main Theme}} &
  \multicolumn{1}{c}{\textbf{Codes}} \\ \hline
\begin{tabular}[c]{@{}l@{}}interactions between \\ non-disabled students \\ with peers with \\ disabilities\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}Friendships and positive \\ interactions- positive \\ and negative behavioral \\ issues- positive impact \\ of inclusion on both set \\ of students.\end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}Factors influencing \\ peers' interactions.\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}Family factors- previous \\ experience with individual \\ with SEN- time factor- \\ encouraging activities.\end{tabular} \\ \hline
\end{tabular}%
}
\end{table}
